...
export default function AdminDashboard() {
  ...
  const sidebarItems = [
    { label: 'Dashboard', to: '/admin', icon: 'home', roles: ['admin'] },
    { label: 'Courses', to: '/admin#courses', icon: 'book', roles: ['admin'] },
    { label: 'Assignments', to: '/admin#assignments', icon: 'clipboard', roles: ['admin'] },
  ];
